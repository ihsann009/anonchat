      ...
      {activeTopic ? (
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Topik</h2>
              <p className="text-gray-500 mt-1">Bergabung dalam percakapan atau buat topik baru</p>
            </div>
            <button
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 text-indigo-600">
              ...
              <p className="text-sm font-medium text-gray-500">Memuat topik...</p>
            </div>
          ) : error ? (
